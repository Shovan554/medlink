...
function Reports() {
  ...
  const fetchReportData = async () => {
    if (!selectedMetric || !startDate || !endDate) {
      setError('Please select metric and date range');
      return;
    }
    ...
    try {
      ...
      // Determine table type based on selected metric
  ...
  const downloadReport = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        a.href = url;
        a.download = `${getMetricDisplayName(selectedMetric)}_Report_${startDate}_to_${endDate}.pdf`;
  ...
  return (
    <div className="reports-container">
      <h1>Health Data Reports</h1>
      <h3>Generate your reports here</h3>
